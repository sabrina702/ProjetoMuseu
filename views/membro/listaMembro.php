...
<head>
  ...
  <link rel="stylesheet" href="/ProjetoMuseu/static/css/estiloGerenciaMembro.css"/>
    ...
    <main class="main-content">
      ...
      <?php endif; ?>
        ...
        <header class="header">
            ...
            <a href="/ProjetoMuseu/template/CadastraMembro.php"  style="text-decoration: none" class="btn-add"> + Novo Membro </a>
        </header>
