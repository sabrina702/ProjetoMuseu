    ...
    <main class="container my-5 position-relative pt-5">
        ...
        <section class="sobre-grid">
            <div class="item imagem fundo-verde">
              <img src="/ProjetoMuseu/static/imagens/temporaria.png" alt="Histórico do museu">
            </div>
            ...
            <div class="item imagem fundo-marrom">
              <img src="/ProjetoMuseu/static/imagens/temporaria.png" alt="Reforma do museu">
            </div>
        
            <div class="item imagem fundo-azul">
              <img src="/ProjetoMuseu/static/imagens/temporaria.png" alt="Missão e visão do museu">
            </div>
            <div class="item texto">
            ...
            <div class="item imagem fundo-laranja">
              <img src="/ProjetoMuseu/static/imagens/temporaria.png" alt="Curiosidades do museu">
            </div>
          </section>
